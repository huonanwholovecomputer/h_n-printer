...
// 部署/测试时通过 localStorage 覆盖一次即可（浏览器控制台执行）:
//   localStorage.setItem('hn_base_url', 'https://你的真实地址')
const BASE_URL = localStorage.getItem('hn_base_url') || 'https://your-server.com';
